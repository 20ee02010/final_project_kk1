...
\TLV my_design()
   ...
   |pipe
      @0 
         ...
         $sum[5:0] = ( {2'b0, $sample1} + {2'b0, $sample2} + {2'b0, $sample3} );  // 3 samples
         $avg_calc[5:0] = $sum / 3;
         
         $avg[3:0] = $valid ? ($avg_calc) : >>1$avg ;       // Divide by 3
...
\SV_plus
   ...
   assign *uio_oe = 8'b0;
         ...
         /*         
            ...
            m5+PmodKYPD(|pipe, /keypad, @1, $ui_in[3:0], 1'b1, ['left:40, top: 80, width: 20, height: 20'])
